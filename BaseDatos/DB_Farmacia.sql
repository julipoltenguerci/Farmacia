...
AS  
       SELECT year(f.fecha_factura), s.nom_sucursal AS Sucursal,  
		   SUM(df.precio_unitario*df.cant_suministro)/COUNT(distinct df.id_factura) AS 'Promedio de Facturaci�n',
